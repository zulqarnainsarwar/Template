...
<head>
    <meta charset="utf-8" />
    <title>Confirm Mail - Admin & Dashboard Template</title>
    <meta
      name="viewport"
                            ...
                            <div class="flex h-[90vh] flex-col">
                                ...
                                <div class="my-auto">
                                    ...
                                    <div class="text-center mt-6">
                                        ...
                                        <p class="text-gray-500 mt-1">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et</p>
                                    </div>

                                    <div class="mt-5">
                                        <a href="auth-login.html" class="btn border-transparent bg-violet-500 w-full py-2.5 text-white shadow-md shadow-violet-200 dark:shadow-zinc-600">Back to Home</a>
                                    </div>
                                </div>
