...
<head>
    <meta charset="utf-8" />
    <title>Lock Screen - Admin & Dashboard Template</title>
    <meta
      name="viewport"
                        ...
                        <div class="flex h-[90vh] flex-col">
                            ...
                            <div class="my-auto">
                                <div class="text-center mb-8">
                                    ...
                                    <p class="text-gray-500 dark:text-zinc-100/60 mt-1">Enter your password to unlock the screen!</p>
                                </div>

                                <div class=" my-5 pt-2 text-center">
                                    <img src="assets/images/users/avatar-1.jpg" class="h-16 w-16 mx-auto rounded-full border p-1 dark:border-zinc-600" alt="thumbnail">
                                    <h5 class="text-15 text-gray-600 dark:text-gray-100 mt-3">Shawn</h5>
                                </div>

                                <form class="mt-4 pt-2" action="index.html">
                                    <div class="mb-6">
                                        <label class="text-gray-600 dark:text-zinc-100 font-medium mb-2 block">Password</label>
                                        <input type="password" class="w-full rounded placeholder:text-sm py-2 placeholder:text-gray-400 border-gray-100 dark:bg-zinc-700/50 dark:border-zinc-600 dark:text-zinc-100" id="password" placeholder="Enter password">
                                    </div>
                                    
                                    <div class="mb-4">
                                        <button class="btn border-transparent bg-violet-500 w-full py-2.5 text-white w-100 waves-effect waves-light shadow-md shadow-violet-200 dark:shadow-zinc-600" type="submit">Unlock</button>
                                    </div>
                                </form>
                                
                                <div class="mt-12 text-center">
                                    <p class="text-gray-500 dark:text-zinc-100">Not you ? return <a href="login.html" class="text-violet-500 font-semibold"> Sign In </a> </p>
                                </div>
                            </div>
