...
<head>
    <meta charset="utf-8" />
    <title>Logout - Admin & Dashboard Template</title>
    <meta
      name="viewport"
                    ...
                    <div class="w-full bg-white xl:p-12 p-10 dark:bg-zinc-800">
                        <div class="flex h-[90vh] flex-col">
                            ...
                            <div class="my-auto">
                                ...
                                <div class="mt-5">
                                    <a href="auth-login.html" class="btn border-transparent bg-violet-500 w-full py-2.5 text-white shadow-md shadow-violet-200 dark:shadow-zinc-600">Sign In</a>
                                </div>
                                
                                <div class="mt-12 text-center">
                                    <p class="text-gray-500 dark:text-zinc-100/60">Don't have an account ? <a href="login.html" class="text-violet-500 font-semibold"> Signup </a> </p>
                                </div>
                            </div>
