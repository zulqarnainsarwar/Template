...
gulp.task('watch', function () {
    gulp.watch([paths.src.css.files, paths.src.html.files, "!" + paths.src.css.icons], gulp.series(['html', 'css'], 'browsersyncReload'));
    gulp.watch([paths.src.css.icons], gulp.series('icons', 'browsersyncReload'));
...
gulp.task('build', gulp.series(gulp.parallel('clean:packageLock', 'clean:dist', 'copy:all', 'copy:libs', 'fileinclude', 'css', 'icons', 'js', 'jsPages', 'html')));
